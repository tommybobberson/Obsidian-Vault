...
---
## Overview
**Grouping data in regressions calculates seperate regressions with ==distinct coefficients for each subgroup== within the data**.
...
2.  investigate [[10 effect modification]]  - if the same, the slope (not necessarily the position) of the regression lines will be identical 
